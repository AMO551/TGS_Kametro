...
public class Player_AttackControl : MonoBehaviour
{
    ...
    {  keyControlScript.player_atk();
        ...
        IEnumerator Attack_CoolTime()
        {
            ...
            attacking_flag = true;
            attack_se_count = 0; 
          // keyControlScript.player_atk_stop();
        }
    }
    ...
    //    {
    //       GameMainContol.Instance.AddReflectCrystalCount();
    //        collision.gameObject.SetActive(false);   //攻撃オブジェクトの破棄
    //    }
    //}
}