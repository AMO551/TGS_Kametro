...
public class JewelDisplay : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (judge == 0)
        {
            ...
            rfrectTransform.position = new Vector3(0, 0);
            wgrectTransform.localScale = new Vector3(0.5f, 0.5f);
            wgrectTransform.position = new Vector3(90, -14);
            exrectTransform.localScale = new Vector3(0.5f, 0.5f);
            exrectTransform.position = new Vector3(-90, -14);
        }
        //ex
        else if (judge == 1)
        {
            ...
            exrectTransform.position = new Vector3(0, 0);
            rfrectTransform.localScale = new Vector3(0.5f, 0.5f);
            rfrectTransform.position = new Vector3(90, -14);
            wgrectTransform.localScale = new Vector3(0.5f, 0.5f);
            wgrectTransform.position = new Vector3(-90, -14);
        ...
        else if (judge == 2)
        {
            ...
            wgrectTransform.position = new Vector3(0, 0);
            exrectTransform.localScale = new Vector3(0.5f, 0.5f);
            exrectTransform.position = new Vector3(90, -14);
            rfrectTransform.localScale = new Vector3(0.5f, 0.5f);
            rfrectTransform.position = new Vector3(-90, -14);
