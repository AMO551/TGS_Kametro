...
public class BlockGauge : MonoBehaviour
{
    ...
    private void Gauge()
    {
        ...
        if (blocks == 0)
        {
            img.GetComponent<Image>().fillAmount = gauge + timer * zeroBGauge;
        ...
        if (blocks == 1)
        {
            img.GetComponent<Image>().fillAmount = gauge - timer / oneBGauge;
            gauge = img.GetComponent<Image>().fillAmount;
        ...
        if (blocks == 2)
        {
            img.GetComponent<Image>().fillAmount = (float)(gauge - timer / twoBGauge);
            gauge = img.GetComponent<Image>().fillAmount;
        ...
        if (blocks == 3)
        {
            img.GetComponent<Image>().fillAmount = gauge - timer / threeBGauge;
            gauge = img.GetComponent<Image>().fillAmount;
        ...
        if (blocks == 4)
        {
            img.GetComponent<Image>().fillAmount = gauge - timer / fourBGauge;
            gauge = img.GetComponent<Image>().fillAmount;
        ...
        if (blocks >= 5)
        {
            img.GetComponent<Image>().fillAmount = (float)(gauge - timer / fiveBGauge);
            gauge = img.GetComponent<Image>().fillAmount;
